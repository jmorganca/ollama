...
| tensor_split   | How split tensors should be distributed across GPUs, for example "25,75" on two GPU system will use more memory for layers on the second GPU.                                                                                                           | string     | tensor_split "25,75" |
