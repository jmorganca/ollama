...
for TARGETARCH in amd64 arm64; do
    ...
    docker cp gpubuilder-$TARGETARCH:/go/src/github.com/jmorganca/ollama/ollama-cov ./dist/ollama-linux-$TARGETARCH-cov
    ...
    docker cp cpubuilder-$TARGETARCH:/go/src/github.com/jmorganca/ollama/ollama-cov ./dist/ollama-linux-$TARGETARCH-cpu-cov
